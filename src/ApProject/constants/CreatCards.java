...
public abstract class CreatCards {
    ...
    public static void createAllCards(){
        ...
        allCards.put("Luthien,TheHighPriestess", new HeroMonsterCard("Luthien,TheHighPriestess", 2000, 0, 1, MonsterCardSpeciality.Normal, Tribe.Elven, magics, battleCry,will));
        magics.clear();
        battleCry.clear();
        will.clear();
